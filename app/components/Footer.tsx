  ...
  return (
    <footer className={`w-full bg-[#18181b] text-white overflow-hidden ${className}`}>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 pt-12 md:pt-20 pb-10 md:pb-12">
        <div className="grid grid-cols-2 md:grid-cols-12  md:gap-6">

          {/* Left — Brand Headline + Contact */}
          <div className="col-span-1 md:col-span-5 flex flex-col gap-6 md:gap-8">
            <div>
              {/* Mobile Headline */}
              <h2 className="block md:hidden text-4xl font-bold text-white tracking-tight leading-tight mb-4 font-display">
                WEBNOIA
              </h2>

              {/* Desktop / Tablet Headline */}
              <h2 className="hidden md:block text-5xl lg:text-6xl font-bold text-white tracking-tight leading-tight mb-6 font-display">
                Let&apos;s Talk
              </h2>
          ...
          {/* Middle — Nav Columns */}
          <div className="col-span-1 md:col-span-4 grid grid-cols-2 gap-4 sm:gap-8 pt-0 md:pt-0 border-t-0 md:border-t-0">
      ...
      <div className="border-t border-white/[0.08] bg-black/20">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-5 flex flex-row items-center justify-between gap-4">
          ...
          {/* Copyright */}
          <p className="text-white/40 text-xs md:text-sm text-right font-sans whitespace-nowrap">
