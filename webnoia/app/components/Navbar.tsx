        ...
        >
          ...
          >
            <div className="flex h-[52px] w-[52px] items-center justify-center rounded-full border border-gray-200 bg-white p-[3px] shadow-sm transition-transform duration-300 group-hover:scale-105">
              <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-full bg-[#1e4a40]">
                <img src="/logos/webnoia.svg" alt="Webnoia" className="h-8 w-8 object-contain" />
              </div>
            </div>
          </Link>
        </div>
